...
We will use some of the [primers](https://posit.cloud/learn/primers) offered and developed by RStudio, mostly around introducing `R` programming, data visualization, and data cleaning in `R`. You will be working through:

-   [Programming Basics](https://posit.cloud/learn/primers/1.2),
-   [Visualization Basics](https://posit.cloud/learn/primers/1.1),
-   [Working with Tibbles](https://posit.cloud/learn/primers/2.1), and
...
The team at the [UO Libraries' Statistical Help Desk](https://library.uoregon.edu/research-data-management/consultations) is here to assist you with everything from intermediate statistics-based coursework to dissertation-level analysis. They are available this term **Monday through Friday 11am to 4pm** with in-person support at the [Knight Library DREAM Lab](https://map.uoregon.edu/f36893138) and [by appointment](https://uoregon.libcal.com/appointments?lid=916&g=7803) (in person or via Zoom). They cover a wide array of topics, including introductory and advanced statistics, statistical software (like R and Python), research design, GIS, git/GitHub, Zotero, and qualitative software like Dedoose.

In addition to one-on-one assistance, they also provide a series of workshops. This term, workshops encompass a range of topics from [introduction to R](https://uoregon.libcal.com/event/11326378) (!) and [Python](https://uoregon.libcal.com/event/11228199) to effectively managing citations with Zotero. They also offer specialized workshops upon request, including qualitative data analysis and GitHub tutorials.

They host Friday lunch chats, [**Coffee + Data && Code**](https://uoregon.libcal.com/event/11326111) that provide an opportunity for students and faculty to connect with like-minded peers from across the university. This term, they're hosting a book club exploring [How Statistics Revolutionized Science in the Twentieth Century](https://uoregon.libcal.com/event/11326128) and reading David Salsburg's [The Lady Tasting Tea: How Statistics Revolutionized Science in the Twentieth Century](https://en.wikipedia.org/wiki/The_Lady_Tasting_Tea) (such a fun read!).
...
-   [Programming Basics](https://posit.cloud/learn/primers/1.2): screenshot of **Types \> Character or object?**
-   [Visualization Basics](https://posit.cloud/learn/primers/1.1): screenshot of **A code template \> A graphing template**
-   [Working with Tibbles](https://posit.cloud/learn/primers/2.1): screenshot of **tidyverse \> Quiz**
-   [Join Data Sets](https://posit.cloud/learn/primers/4.3): screenshot of **Mutating Joins \> Test your comprehension**
