...
If your homework is not submitted prior to the start of the following class without approval from the instructor, it will receive at most 5 points when/if it is submitted. If your homework is submitted more than two weeks late, it will receive zero points. 
