...
::: {.column width="50%"}
[**For this class**](https://jnese.github.io/intro-DS-R_fall-2024/)
...
[**https://jnese.github.io/intro-DS-R_fall-2024/**](https://jnese.github.io/intro-DS-R_fall-2024/)

-   [schedule](https://jnese.github.io/intro-DS-R_fall-2024/schedule.html)
-   [slides](https://jnese.github.io/intro-DS-R_fall-2024/schedule.html) (posted *before* each class)
-   [assignments](https://jnese.github.io/intro-DS-R_fall-2024/assignments.html) (posted *after* each class)
-   [syllabus](https://jnese.github.io/intro-DS-R_fall-2024/syllabus.html)
-   [data](https://jnese.github.io/intro-DS-R_fall-2024/data_list.html)
...
-   Homeworks are generally due the class after they are assigned, before class starts
    - 1 week late: 5 points (max)
    - 2 weeks late: 0 points
...
-   **Week 3 (10/16)**: Self-selected groups finalized
-   **Week 5 (10/30)**: Final Project Outline due
-   **Week 9 (11/28)**: Data prep script due
-   **Week 10 (12/4)**: Peer review due
-   **Week 10 (12/4)**: Final project presentations
-   **Week 11 (12/11)**: Final Paper due
...
[Installs](https://jnese.github.io/intro-DS-R_fall-2024/installs.html)
...
-   Expanding on a daily basis
    + Currently, the CRAN package repository features 21,000+ packages 
    + 19,900+ last year at this time
...
-   Reading
    ...
    -   [Week 1 reading](https://jnese.github.io/intro-DS-R_fall-2024/#week-1-introduction) (if you haven't already)
...
-   Assignments
    ...
    -   [Installs](https://jnese.github.io/intro-DS-R_fall-2024/install.qmd)
